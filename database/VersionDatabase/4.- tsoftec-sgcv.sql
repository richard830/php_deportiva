...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2024 a las 05:52:13
...
--
ALTER TABLE `login_history`
  MODIFY `LHid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `quota_hour`
  MODIFY `QHid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
