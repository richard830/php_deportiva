...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2024 a las 06:02:02
...
(22, 6, 2, 1, 3, 1, '2024-05-16 03:10:38', '2024-05-19 01:21:22'),
...
CREATE TABLE `course_info` (
  ...
  `CIkit` varchar(100) DEFAULT NULL,
...
INSERT INTO `course_info` (`CIid`, `Cid`, `CIprice`, `CIimage`, `CIkit`, `CIdescription`, `CIdateCreated`, `CIdateUpdated`) VALUES
(1, 21, 40.00, 'ajedrez.jpeg', '', 'CURSO VACACIONAL 2024', '2024-05-16 02:29:39', '2024-05-20 06:47:52'),
(2, 22, 30.00, 'atletismo.jpeg', '', 'CURSO VACACIONAL 2024\r\n', '2024-05-16 03:10:38', '2024-05-19 01:21:22'),
...
(28, 49, 20.00, 'TSoftec.png', 'CAMISETA', 'PASDLI', '2024-05-17 03:48:42', '2024-05-20 01:15:10');
...
CREATE TABLE `invoice` (
  ...
  `PSid` int(3) NOT NULL,
  `KDid` int(3) NOT NULL,
  `Ibanco` varchar(30) NOT NULL,
  `Iimage` varchar(255) DEFAULT NULL,
  `Ivoucher` varchar(13) DEFAULT NULL,
...
INSERT INTO `invoice` (`Iid`, `Uid`, `Cid`, `Did`, `QHid`, `TPid`, `PSid`, `KDid`, `Ibanco`, `Iimage`, `Ivoucher`, `Idate`, `IdateCreated`, `IdateUpdated`) VALUES
(1, 1, 21, 1, 13, 1, 2, 1, 'Banco Pichincha', 'FbWKZi9WQAEUyun.jpg', '12365487', '2024-05-21', '2024-05-22 04:00:57', '2024-05-22 04:00:57');
...
INSERT INTO `payment_types` (`TPid`, `TPname`, `TPdateCreated`, `TPdateUpdated`) VALUES
...
(13, 21, 14, 40, '08:00:00', '10:00:00', '2024-05-16 02:29:39', '2024-05-19 01:18:37'),
(14, 22, 1, 40, '08:00:00', '10:00:00', '2024-05-16 03:10:38', '2024-05-19 01:10:23'),
...
(51, 21, 14, 30, '10:15:00', '12:15:00', '2024-05-18 22:41:40', '2024-05-19 00:50:43'),
...
(39, 'ROBERTO CARLOS', 'GOMEZ NUNEZ', '0504053216', '1995-08-09', 'Femenino', 'QUITO', 'QUITO', 'roberto', 'roberto@gmail.com', '$2y$10$WZRejbBvjHj02EK4EHawg.GpHswjex6ood9Hxb2m9zcocF/veM7uq', '0995411589', 'roberto', 'roberto', '3d-payment-money-dollar-credit-card-png.webp', '', 1, '2024-04-29 05:17:39', '2024-04-29 05:17:39'),
(40, 'CAJERO', 'PRUEBA', '0504053211', '1995-08-09', 'Prefiero no decirlo', 'QUITO', 'QUITO', 'cajero', 'cajero@tsoftec.com', '$2y$10$o25TYguhotWR2/Q.d7T9LOo/33lPNtsxJlLSwWlPFeNrw5yH478dq', '0995411589', '', '', 'users.jpg', '', 1, '2024-05-19 22:59:50', '2024-05-19 22:59:50'),
(41, 'CLIENTE', 'PRUEBA', '0504053212', '1995-08-09', 'Prefiero no decirlo', 'QUITO', 'QUITO', 'cliente', 'cliente@tsoftec.com', '$2y$10$CD52pi.F01OGgKVqf12pROPGvbWBobqgui2G.7rO/D53GkmnHHraO', '0995411589', '', '', 'users.jpg', '', 1, '2024-05-19 23:38:05', '2024-05-19 23:38:05');
...
--
ALTER TABLE `course_info`
  MODIFY `CIid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `invoice`
  MODIFY `Iid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `login_history`
  MODIFY `LHid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `payment_types`
  MODIFY `TPid` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `quota_hour`
  MODIFY `QHid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
ALTER TABLE `invoice`
  ...
  ADD CONSTRAINT `invoice_ibfk_5` FOREIGN KEY (`TPid`) REFERENCES `payment_types` (`TPid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `invoice_ibfk_6` FOREIGN KEY (`PSid`) REFERENCES `payment_status` (`PSid`) ON DELETE CASCADE ON UPDATE CASCADE,
