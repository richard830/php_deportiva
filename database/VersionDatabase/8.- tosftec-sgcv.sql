...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2024 a las 10:45:00
...
CREATE TABLE `payment_type` (
  ...
  `PTdateCreated` timestamp NOT NULL DEFAULT current_timestamp(),
  `PTdateUpdated` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `payment_type` (`PTid`, `PTname`, `PTdateCreated`, `PTdateUpdated`) VALUES
(1, 'Tranferencia', '2024-05-19 22:03:05', '2024-05-19 22:03:05'),
(2, 'Depostivo', '2024-05-19 22:03:22', '2024-05-19 22:03:22'),
(3, 'Efectivo', '2024-05-19 22:03:22', '2024-05-19 22:03:22');
...
--
ALTER TABLE `login_history`
  MODIFY `LHid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
ALTER TABLE `payment_type`
  MODIFY `PTid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
