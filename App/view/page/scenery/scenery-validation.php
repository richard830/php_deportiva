<script>
    function validateFormCreate() {
        ...
        var submitButton = document.getElementById("submit-scenery-add");
        if (isValid) {
    ...
    document.getElementById("formSceneryCreate").addEventListener("input", validateFormCreate);
    ...
    function validateFormUpdateScenery() {
        var isValid = true;
        validateNameUpdate();
        ...
        var submitButton = document.getElementById("submit-scenery-update");
        if (isValid) {
            submitButton.removeAttribute("disabled");
        } else {
            submitButton.setAttribute("disabled", "disabled");
