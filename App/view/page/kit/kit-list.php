                            ...
                            <div class="row">                               
                                <div class="form-group col-md-12 ">
                                    <div class="form-floating mb-2">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nombre del Kit" required oninput="validateFormCreate()">
                                        <label for="rename">kit</label>
                                    </div>
                                   
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary" id="submit-kit-add" name="submit-kit-add" disabled>
