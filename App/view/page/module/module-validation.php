<script>
    function validateFormCreate() {
        ...
        var submitButton = document.getElementById("submit-module-add");
        if (isValid) {
    ...
    document.getElementById("formModuleCreate").addEventListener("input", validateFormCreate);
    ...
    function validateFormUpdateModule() {
        var isValid = true;
        validateNameUpdate();
        ...
        var submitButton = document.getElementById("submit-module-update");
        if (isValid) {
            submitButton.removeAttribute("disabled");
        } else {
            submitButton.setAttribute("disabled", "disabled");
