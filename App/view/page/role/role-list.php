...
include 'role-validation.php';
include 'role-pagination.php';
    ...
    <div class="card">
                        ...
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <a class=" btn btn-primary" data-bs-toggle="modal" data-bs-target="#role-add">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="datatable" class="table" role="grid" width="100%">
                    <thead>
                        <tr>
                            <th>N°</th>
...
<div class="modal fade" id="role-add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Nueva role</h5>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="name" name="name" data-bs-toggle="tooltip" title="Agregar roles que no se repitan" placeholder="Nombre del rol" required oninput="validateFormCreateRole()">
                                        <label for="Uname">Nombre del rol</label>
                                    </div>
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" id="submit-role-add" class="btn btn-primary" name="submit-role-add" disabled>
